...
private:
	StringSize	beginPosition_;//no needed this variable

	stringstream iss;//String stream variable to help break out words from a line.
	...
	vector<string>  ExclusionWords;//Vector to hold all exclusions words.
};
...
private:
	map<string, set<int>> Index;//map to hold final index page
	map<string, vector<int>> TempIndex;//map to hold index page including repeated words.
};
